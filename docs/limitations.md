...
- Dead Publish waiter cleanup uses native process liveness on Unix and Windows. Access-denied Windows processes remain live. Queue waiters time out after five minutes without queue progress; an advancing queue can take longer.
